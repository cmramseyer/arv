class OrdenFumigacionSerializer
  ...
  FULL_SHOW_KEYS = %w(id estancia_id nombre_estancia lote_id nombre_lote hectareas estado_orden dosis info_trabajo datos_clima maquinista creado_por created_at updated_at)
