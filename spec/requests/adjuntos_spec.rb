...
RSpec.describe "/adjuntos", type: :request do
  ...
  describe "GET /index" do
    it "returns adjuntos from lotes and orden" do
      ...
      lote_uno_adjunto = lote_uno.adjuntos.last
      lote_uno.adjuntos.attach(file_jpg)
      lote_uno_adjunto_dos = lote_uno.adjuntos.last
      lote_dos.adjuntos.attach(file_png_two)
      lote_dos_adjunto = lote_dos.adjuntos.last
      orden.adjuntos.attach(file_png)
      orden_adjunto = orden.adjuntos.last
      ...
      expect(json_response.map { |adjunto| adjunto["id"] }).to match_array(
        [ lote_uno_adjunto.id, lote_uno_adjunto_dos.id, lote_dos_adjunto.id, orden_adjunto.id ]
      )
    end
